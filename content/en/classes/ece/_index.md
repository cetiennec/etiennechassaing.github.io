---
title: ECE Paris — Sampled Control Systems
summary: "Digital control: lecture decks, final exam and midterm quiz."
type: docs
math: true
---
...
LaTeX sources live in a private repository; the distributed PDFs are published to
...
The exam is built as a single running case study on the altitude control of an
observation drone — modelling, closed-loop control, discretisation and filtering.

- 📄 **[Full paper, transcribed and annotated](examen-final/)**

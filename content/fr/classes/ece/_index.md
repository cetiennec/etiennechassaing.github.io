---
title: ECE Paris — Systèmes Bouclés
summary: "Régulation numérique : diaporamas, examen final et QCM de mi-parcours."
type: docs
math: true
---
...
L'examen est construit comme une étude de cas filée sur le contrôle en altitude d'un
drone d'observation — modélisation, asservissement, discrétisation et filtrage.

- 📄 **[Sujet complet, transcrit et commenté](examen-final/)**
